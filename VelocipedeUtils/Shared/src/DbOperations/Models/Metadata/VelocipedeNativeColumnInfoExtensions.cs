...
/// <summary>
/// Extension methods for <see cref="VelocipedeNativeColumnInfo"/>.
/// </summary>
public static class VelocipedeNativeColumnInfoExtensions
{
    ...
    public static DbType? GetSqliteDbType(this VelocipedeNativeColumnInfo columnInfo)
    {
    ...
    /// <param name="columnInfo">Column metadata.</param>
    /// <returns></returns>
    public static DbType? GetPostgresDbType(this VelocipedeNativeColumnInfo columnInfo)
    {
        if (string.IsNullOrEmpty(columnInfo.NativeColumnType))
            return null;
    ...
    /// <param name="columnInfo">Column metadata.</param>
    /// <returns></returns>
    public static DbType? GetMssqlDbType(this VelocipedeNativeColumnInfo columnInfo)
    {
        if (string.IsNullOrEmpty(columnInfo.NativeColumnType))
            return null;
        ...
        switch (nativeColumnType)
        {
            ...
            case "real" or "float" or "double precision":
                result = DbType.Double;
                columnInfo.CharMaxLength = null;
                columnInfo.NumericPrecision = null;
                columnInfo.NumericScale = null;
