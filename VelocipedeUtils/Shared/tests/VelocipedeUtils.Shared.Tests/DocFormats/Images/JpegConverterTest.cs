...
namespace Cims.Tests.VelocipedeUtils.Shared.Office.DocFormats.Images
{
    public class JpegConverterTest
    {
        ...
        private readonly string FolderName = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), typeof(JpegConverterTest).ToString().Split('.').Last());
