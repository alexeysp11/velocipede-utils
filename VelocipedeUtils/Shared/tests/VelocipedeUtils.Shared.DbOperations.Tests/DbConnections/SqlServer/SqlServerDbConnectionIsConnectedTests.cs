...
public sealed class SqlServerDbConnectionIsConnectedTests : BaseDbConnectionIsConnectedTests
{
    /// <summary>
    /// Default constructor.
    /// </summary>
    public SqlServerDbConnectionIsConnectedTests() : base(VelocipedeDatabaseType.MSSQL)
    {
    ...
    {
        // Arrange & Act.
        string result = SqlServerDbConnection.GetDatabaseName(connectionString);
