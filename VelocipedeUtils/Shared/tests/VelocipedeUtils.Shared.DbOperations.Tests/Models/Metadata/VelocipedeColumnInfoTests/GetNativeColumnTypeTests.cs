...
public sealed class GetNativeColumnTypeTests
{
    ...
    {
        static TestCaseNativeColumnType[] GetColumnInfoRealByDatabaseType(VelocipedeDatabaseType databaseType) => [
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Double }, ExpectedNativeType = "double precision" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Single }, ExpectedNativeType = "double precision" },
        ];

        TheoryData<TestCaseNativeColumnType> result = [];
        result.AddRange(GetColumnInfoRealByDatabaseType(VelocipedeDatabaseType.SQLite));
        result.AddRange(GetColumnInfoRealByDatabaseType(VelocipedeDatabaseType.PostgreSQL));
        result.AddRange(GetColumnInfoRealByDatabaseType(VelocipedeDatabaseType.MSSQL));
        return result;
    }
    ...
    {
        static TestCaseNativeColumnType[] GetColumnInfoCurrencyByDatabaseType(VelocipedeDatabaseType databaseType) => [
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = null, NumericScale = null }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = null, NumericScale = 0 }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = null, NumericScale = -1 }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = null, NumericScale = 2 }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = null, NumericScale = 4 }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = -1, NumericScale = null }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = -1, NumericScale = -1 }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 0, NumericScale = null }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 0, NumericScale = 0 }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 2, NumericScale = null }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 2, NumericScale = -1 }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 2, NumericScale = 2 }, ExpectedNativeType = $"numeric(2, 2)" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 4, NumericScale = null }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 4, NumericScale = -1 }, ExpectedNativeType = $"numeric({NumericConstants.CurrencyDefaultPrecision}, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 4, NumericScale = 2 }, ExpectedNativeType = $"numeric(4, 2)" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 4, NumericScale = 4 }, ExpectedNativeType = $"numeric(4, 4)" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 5, NumericScale = null }, ExpectedNativeType = $"numeric(5, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 5, NumericScale = -1 }, ExpectedNativeType = $"numeric(5, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 5, NumericScale = 0 }, ExpectedNativeType = $"numeric(5, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 5, NumericScale = 2 }, ExpectedNativeType = $"numeric(5, 2)" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 5, NumericScale = 4 }, ExpectedNativeType = $"numeric(5, 4)" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 5, NumericScale = 5 }, ExpectedNativeType = $"numeric(5, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 10, NumericScale = null }, ExpectedNativeType = $"numeric(10, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 10, NumericScale = 5 }, ExpectedNativeType = $"numeric(10, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 10, NumericScale = 10 }, ExpectedNativeType = $"numeric(10, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 15, NumericScale = null }, ExpectedNativeType = $"numeric(15, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 15, NumericScale = -1 }, ExpectedNativeType = $"numeric(15, {NumericConstants.CurrencyDefaultScale})" },
            new() { ColumnInfo = new() { ColumnName = COLUMN_NAME, DatabaseType = databaseType, ColumnType = DbType.Currency, NumericPrecision = 15, NumericScale = 15 }, ExpectedNativeType = $"numeric(15, {NumericConstants.CurrencyDefaultScale})" },
        ];

        TheoryData<TestCaseNativeColumnType> result = [];
        result.AddRange(GetColumnInfoCurrencyByDatabaseType(VelocipedeDatabaseType.SQLite));
        result.AddRange(GetColumnInfoCurrencyByDatabaseType(VelocipedeDatabaseType.PostgreSQL));
        result.AddRange(GetColumnInfoCurrencyByDatabaseType(VelocipedeDatabaseType.MSSQL));
        return result;
    }
